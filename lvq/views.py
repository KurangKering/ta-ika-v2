...
def proses_import_data_awal(request):
    ...
    for row in data_post:
        dataset = Dataset()
        dataset.clump_thickness = float(row['clump_thickness'])
        dataset.uniformity_of_cell_size = float(row['uniformity_of_cell_size'])
        dataset.uniformity_of_cell_shape = float(row['uniformity_of_cell_shape'])
        dataset.marginal_adhesion = float(row['marginal_adhesion'])
        dataset.single_epithelial_cell_size = float(row['single_epithelial_cell_size'])
        dataset.bare_nuclei = float(row['bare_nuclei'])
        dataset.bland_chromatin = float(row['bland_chromatin'])
        dataset.normal_nucleoli = float(row['normal_nucleoli'])
        dataset.mitoses = float(row['mitoses'])
        dataset.kelas = float(row['kelas'])
...
def proses_preprocessing(request):
    ...
    model_instances = [DatasetPreprocessing(clump_thickness=dataset.clump_thickness,
                                            ...
                                            uniformity_of_cell_shape=dataset.uniformity_of_cell_shape,
                                            marginal_adhesion=dataset.marginal_adhesion,
                                            single_epithelial_cell_size=dataset.single_epithelial_cell_size,
                                            bare_nuclei=dataset.bare_nuclei,
                                            bland_chromatin=dataset.bland_chromatin,
                                            normal_nucleoli=dataset.normal_nucleoli,
                                            mitoses=dataset.mitoses,
...
def generate_bobot_awal(request):
    ...
    for x in range(len(index_bobot)):
        ...
        bobot_awal.x1 = bobot['clump_thickness']
        bobot_awal.x2 = bobot['uniformity_of_cell_size']
        bobot_awal.x3 = bobot['uniformity_of_cell_shape']
        bobot_awal.x4 = bobot['marginal_adhesion']
        bobot_awal.x5 = bobot['single_epithelial_cell_size']
        bobot_awal.x6 = bobot['bare_nuclei']
        bobot_awal.x7 = bobot['bland_chromatin']
        bobot_awal.x8 = bobot['normal_nucleoli']
        bobot_awal.x9 = bobot['mitoses']
